...
type Game_createReadyRoom_c2s struct {
	MsgId    uint16
	GameId   uint16
	UserId   string
	UserName string
...
func NewGame_createReadyRoom_c2s() *Game_createReadyRoom_c2s {
	return &Game_createReadyRoom_c2s{
		MsgId: ID_Game_createReadyRoom_c2s,
	}
}

func (this *Game_createReadyRoom_c2s) Encode() []byte {
...
func (this *Game_createReadyRoom_c2s) Decode(msg []byte) {
