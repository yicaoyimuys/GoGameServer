...
type Game_joinReadyRoom_c2s struct {
	MsgId    uint16
	RoomId   string
	UserId   string
	UserName string
...
func NewGame_joinReadyRoom_c2s() *Game_joinReadyRoom_c2s {
	return &Game_joinReadyRoom_c2s{
		MsgId: ID_Game_joinReadyRoom_c2s,
	}
}

func (this *Game_joinReadyRoom_c2s) Encode() []byte {
...
func (this *Game_joinReadyRoom_c2s) Decode(msg []byte) {
